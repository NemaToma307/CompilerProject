...
//        return super.visitElement(ctx);
    ...
    @Override
    public AST visitConditions_withOR_NUM_NUM(projectParser.Conditions_withOR_NUM_NUMContext ctx) {
        return super.visitConditions_withOR_NUM_NUM(ctx);
    }

    @Override
    public AST visitConditions_withAND_NUM_NUM(projectParser.Conditions_withAND_NUM_NUMContext ctx) {
        return super.visitConditions_withAND_NUM_NUM(ctx);
    }

    @Override
    public AST visitConditions_withOR_NUM_ID(projectParser.Conditions_withOR_NUM_IDContext ctx) {
        return super.visitConditions_withOR_NUM_ID(ctx);
    }

    @Override
    public AST visitConditions_withAND_NUM_ID(projectParser.Conditions_withAND_NUM_IDContext ctx) {
        return super.visitConditions_withAND_NUM_ID(ctx);
    }

    @Override
    public AST visitConditions_withOR_ID_ID(projectParser.Conditions_withOR_ID_IDContext ctx) {
        return super.visitConditions_withOR_ID_ID(ctx);
    }

    @Override
    public AST visitConditions_withAND_ID_ID(projectParser.Conditions_withAND_ID_IDContext ctx) {
        return super.visitConditions_withAND_ID_ID(ctx);
    }

    @Override
    public AST visitConditions_withOR_ID_NUM(projectParser.Conditions_withOR_ID_NUMContext ctx) {
        return super.visitConditions_withOR_ID_NUM(ctx);
    }

    @Override
    public AST visitConditions_withAND_ID_NUM(projectParser.Conditions_withAND_ID_NUMContext ctx) {
        return super.visitConditions_withAND_ID_NUM(ctx);
    }
