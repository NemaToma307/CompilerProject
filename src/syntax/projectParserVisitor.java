...
public interface projectParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code conditions_withOR_NUM_NUM}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withOR_NUM_NUM(projectParser.Conditions_withOR_NUM_NUMContext ctx);
	/**
	 * Visit a parse tree produced by the {@code conditions_withAND_NUM_NUM}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withAND_NUM_NUM(projectParser.Conditions_withAND_NUM_NUMContext ctx);
	/**
	 * Visit a parse tree produced by the {@code conditions_withOR_NUM_ID}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withOR_NUM_ID(projectParser.Conditions_withOR_NUM_IDContext ctx);
	/**
	 * Visit a parse tree produced by the {@code conditions_withAND_NUM_ID}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withAND_NUM_ID(projectParser.Conditions_withAND_NUM_IDContext ctx);
	/**
	 * Visit a parse tree produced by the {@code conditions_withOR_ID_ID}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withOR_ID_ID(projectParser.Conditions_withOR_ID_IDContext ctx);
	/**
	 * Visit a parse tree produced by the {@code conditions_withAND_ID_ID}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withAND_ID_ID(projectParser.Conditions_withAND_ID_IDContext ctx);
	/**
	 * Visit a parse tree produced by the {@code conditions_withOR_ID_NUM}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withOR_ID_NUM(projectParser.Conditions_withOR_ID_NUMContext ctx);
	/**
	 * Visit a parse tree produced by the {@code conditions_withAND_ID_NUM}
	 * labeled alternative in {@link projectParser#conditions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditions_withAND_ID_NUM(projectParser.Conditions_withAND_ID_NUMContext ctx);
	/**
