...
conditions : ID SINGLS NUM OR  ID SINGLS NUM   #conditions_withOR_NUM_NUM
           | ID SINGLS NUM AND ID SINGLS NUM   #conditions_withAND_NUM_NUM
           | ID SINGLS NUM OR  ID SINGLS ID    #conditions_withOR_NUM_ID
           | ID SINGLS NUM AND ID SINGLS ID    #conditions_withAND_NUM_ID

           | ID SINGLS ID OR  ID SINGLS ID     #conditions_withOR_ID_ID
           | ID SINGLS ID AND ID SINGLS ID     #conditions_withAND_ID_ID
           | ID SINGLS ID OR  ID SINGLS NUM    #conditions_withOR_ID_NUM
           | ID SINGLS ID AND ID SINGLS NUM    #conditions_withAND_ID_NUM
...
expr: NUM MULTI NUM    #multiplication
    | NUM PLUS NUM     #addition
    | NUM MINUS NUM    #subtraction
    | NUM DIVIDE NUM   #division
    | ID               #identifier
    | NUM              #integer
    ;
...
functionStatement : VOID   ID HLEFT HRIGHT CURLELEFT input CURLERIGHT   #void_Function_NoARG
  ...
  /*  function type WITHOUT return " arghh" */
